...
Adapted from reference/exp2/benchmark_docker.py with:
- DEPLOYMENT env var for labeling results per config
- NCCL-related env var capture in output JSON
"""
...
from benchmark import CommBenchmark, capture_nccl_env
...
def main():
    ...
    deployment = os.environ.get('DEPLOYMENT', 'docker')
    ...
    # In Docker, CUDA_VISIBLE_DEVICES limits which GPU is visible
